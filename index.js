...
import { buscarHistorico, buscarHistoricoPorAno, buscarHistoricoPorId, calcularInflacao, validacaoErro } from './servicos/servico.js';
...
app.get('/historicoIPCA/calculo', (req, res) => {
  ...
  const resultado = calcularInflacao(valor, dataInicialMes, dataInicialAno, dataFinalMes, dataFinalAno);
